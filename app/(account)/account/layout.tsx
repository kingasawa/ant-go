...
export default function AccountLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: "/account/overview",     label: t("navOverview"),     Icon: HiOutlineSquares2X2,       gradient: "icon-badge-purple", dot: "#9E3EBF" },
    { href: "/account/apps",         label: t("navApps"),         Icon: AiOutlineAppstoreAdd,       gradient: "icon-badge-orange", dot: "#FD951A" },
    { href: "/account/devices",      label: t("navDevices"),      Icon: HiOutlineDevicePhoneMobile, gradient: "icon-badge-teal",   dot: "#2DD4BF" },
    { href: "/account/credentials",  label: t("navCredentials"),  Icon: HiOutlineKey,               gradient: "icon-badge-blue",   dot: "#3B82F6" },
  ];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "var(--dash-bg)" }}>
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-white/40 text-sm">{t("loadingScreen")}</span>
        </div>
      </div>
    );
  }
