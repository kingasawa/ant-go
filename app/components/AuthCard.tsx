        ...
        >
          ...
          <div style={{ ...FACE, transform: "rotateY(180deg)" }}>
            ...
            <form onSubmit={handleEmailRegister} className="space-y-3">
              ...
              <Field type="password" value={regPassword}  onChange={setRegPassword}  placeholder="Password (min. 6)"    icon={<LockIcon />} />
              <Field type="password" value={confirmPwd}   onChange={setConfirmPwd}   placeholder="Confirm password"     icon={<LockIcon />} />
